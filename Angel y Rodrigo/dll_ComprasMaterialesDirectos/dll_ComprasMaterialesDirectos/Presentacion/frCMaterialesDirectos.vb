...
Public Class frCMaterialesDirectos
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        'Inicia
        Conexion.Conectado()
        Dim guardar As String = "INSERT INTO tbl_frm_materiales VALUES ('" + tbControl.Text + "', '" + tbNombre.Text + "', '" + col1c1.ToString + "', '" + col1c2.ToString + "', '" + col1c3.ToString + "', '" + col1c4.ToString + "', '" + col1c5.ToString + "', '" + col1c6.ToString + "', '" + tbGTotal.Text + "', '" + cbId_produccion.SelectedValue.ToString + "', '" + cbId_PProduccion.SelectedValue.ToString + "' )"
    ...
    Public Sub SumarInvDeseado()
        'Try
        '    Dim r As Integer = dgUltimo2.Rows.Count - 1
        '    Dim suma, promedio As Double
        '    Dim ultimoitem As Integer = dgUltimo2.ColumnCount - 2 ' separamos las dos columnas que son de la suma y el promedio
        '    For i As Integer = 0 To ultimoitem
        '        suma = suma + CDbl(dgUltimo2.Item(i, r).Value)
        '    Next
        '    promedio = suma / ultimoitem
        '    dgUltimo2.Item(ultimoitem, r).Value = Format(suma, "0.000")
        '    dgUltimo2.Item(ultimoitem + 1, r).Value = Format(promedio, "0.000")
        'Catch ex As Exception
        'End Try
        'Columna 1 celdas
